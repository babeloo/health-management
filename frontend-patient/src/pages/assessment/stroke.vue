<template>
  <view class="stroke-container">
    <view class="form-section">
      ...
      <view class="form-item">
        <text class="label">心脏病史</text>
        <switch :checked="form.heartDisease" @change="form.heartDisease = $event.detail.value" />
      </view>

      <view class="form-item">
        <text class="label">家族卒中史</text>
...
const handleSubmit = async () => {
  ...
  loading.value = true;
  try {
    const res = await assessmentApi.assessStroke(form.value);
    result.value = res;
